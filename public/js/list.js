(function($) {
    ...
    function getPkmnCryHTML(pkmnNames, extensions, fileName, cryTag) {
        return $(`
            <div class="cryButton">
...
//  STILL USEFUL FOR GENERATING THE PAGES, MIGHT REVERT TO THIS LATER
    ...
    //                 pkmnList.append(getPkmnCryHTML([species], [""], indAsStr, indAsStr));
    ...
    //                             : "";
    //                         pkmnList.append(getPkmnCryHTML([cry], [ending], indAsStr, indAsStr + ending));
